...
export default function PayableTypeManager() {
  const { payableTypes, loading, create, update, remove } = usePayableTypes();
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold mb-4">Payable Types</h3>
      ...
      <ConfirmDialog
        ...
        title="Delete Payable Type"
        message="Are you sure? This will fail if payables are using this type."
      />
    </div>
  );
}
